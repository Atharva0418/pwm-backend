...
//     verify(credentialService).createCredential("TestserviceName", "Testusername",
// "Testpassword@1");
//   }
...
//         .thenThrow(new ResourceNotFoundException("Credential not found with ID " +
// nonexistentId));
...
//   //       .andExpect(jsonPath("$[0].id").value(credential1.getCredentialId()))
...
//   //       .andExpect(jsonPath("$[1].id").value(credential2.getCredentialId()))
...
//     updatedCredential.setCredentialId(credentialID);
...
//                 .contentType(MediaType.APPLICATION_JSON)
//                 .content(
//                     createJsonInput("UpdatedServiceName", "UpdatedUsername",
// "UpdatedPassword@1")))
//         .andExpect(status().isOk())
...
//     String credentialID = "1234";
//     Credential credential = new Credential("TestServicename1", "TestUsername1",
// "TestPassword@1");
